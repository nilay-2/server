...
const forgotPassword = async (req, res, next) => {
  ...
  try {
    ...
    const resetPasswordUrl = `<a href="https://mernauthentication.netlify.app/resetPassword/${token}">Click here to reset password</a>
      <h4>If this above link doesn't work then copy this url to your browser.</h4>
      <h4>https://mernauthentication.netlify.app/resetPassword/${token}</h4>
    `;
